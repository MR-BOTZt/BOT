...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://t.me/CINEMAHUB_NEW_MOVIES")
            ],[
            InlineKeyboardButton("🎥 ᴍᴏᴠɪᴇ ᴜᴘᴅᴀᴛᴇs", url="https://t.me/CINEMAHUB_NEW_MOVIES")
            ],[      
        ...
        buttons = [[
            InlineKeyboardButton('SOURCE CODE', url='https://t.me/CINEMAHUB_NEW_MOVIES')
            ],[
